...
#ifndef FLATBUFFERS_GENERATED_SCHEMA3_NPLEX_MSGS_H_
#define FLATBUFFERS_GENERATED_SCHEMA3_NPLEX_MSGS_H_
...
struct LoginRequest FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  uint32_t schema() const {
    return GetField<uint32_t>(VT_SCHEMA, 0);
  }
...
struct LoginRequestBuilder {
  ...
  void add_schema(uint32_t schema) {
    fbb_.AddElement<uint32_t>(LoginRequest::VT_SCHEMA, schema, 0);
  }
...
#endif  // FLATBUFFERS_GENERATED_SCHEMA3_NPLEX_MSGS_H_
